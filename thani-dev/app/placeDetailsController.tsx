...
const styles = StyleSheet.create({
  ...
  address: { fontSize: 16, color: 'gray', textAlign: 'center', marginBottom: 10 },
  rating: { fontSize: 18, color: '#FFD700', textAlign: 'center', marginBottom: 20 },
  commentsSection: { marginVertical: 20 },
  sectionTitle: { fontSize: 20, fontWeight: 'bold', marginBottom: 10 },
  commentBox: { marginBottom: 15 },
  commentText: { fontSize: 16 },
  commentRating: { fontSize: 18 },
  commentTimestamp: { fontSize: 12, color: 'gray' },
  input: { borderWidth: 1, borderColor: 'gray', borderRadius: 5, padding: 10, marginBottom: 10 },
  ratingRow: { flexDirection: 'row', justifyContent: 'center', marginBottom: 10 },
